...
<template>
   <div class="tw-flex tw-w-full tw-justify-center tw-my-10 tw-select-none">
      <div id="rendered-content" class="tw-w-[893px] tw-h-[1263px] tw-flex tw-justify-center tw-items-center tw-p-1 tw-bg-[#f8f4e3] tw-border-[#61b132] tw-border-[4px]">
        ...
        <div @click="downloadPdf" class="tw-cursor-pointer tw-bg-[#e91956] tw-p-2 tw-px-3 tw-rounded-md tw-text-white tw-text-sm" id="download-pdf"><span>Download Pdf</span></div>
      </div>
      </div>
      <div  :class="['tw-w-1/4  tw-items-center tw-flex-col tw-gap-4 tw-mt-20 tw-bg-white tw-p-2', sidebarDisplay]">
         ...
         <div class="tw-relative tw-flex tw-w-72 tw-flex-col tw-p-1">
            ...
            <span
               ...
               class="tw-block tw-w-full tw-cursor-pointer tw-rounded-md tw-text-white tw-bg-gray-500 tw-p-2 tw-text-[15px] tw-shadow-lg">
               {{ attPlaceholder }}
            </span>
            <ul
         ...
         <span @click="sidebarDisplay = 'tw-hidden'" class="tw-p-1 tw-text-center tw-w-28 tw-text-white tw-bg-black tw-rounded-md tw-cursor-pointer tw-my-5">Hide_Section</span>
